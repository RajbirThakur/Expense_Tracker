<?php
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            if($rowsAffected == 0){
                ...
                $sql = "INSERT INTO `users` (`id`, `Username`, `Email`, `Password`, `date`) VALUES (NULL, '$name', '$email', '$hash', current_timestamp())";
                $res = mysqli_query($conn, $sql);
        ...
        <div class="row w-100 h-100 m-0 shadow-2xl overflow-hidden">
            ...
            <div class="col-md-6 d-flex justify-content-center align-items-center bg-gray-50">
                <div class="login-card p-4 p-md-5 w-full bg-white rounded-xl shadow-lg border border-gray-200">
                    <h2 class="text-3xl font-semibold text-gray-800 mb-2">Welcome!</h2>
                    <p class="text-gray-500 mb-6">Sign up to create your dashboard.</p>

                    <form action="signup.php" method="POST">
                        <!-- Username Field -->
                        <div class="mb-3">
                            <label for="username" class="form-label text-sm font-medium text-gray-700">Username</label>
                            <div class="input-group">
                                <span class="input-group-text bg-gray-100 border-gray-300"><i data-lucide="user"
